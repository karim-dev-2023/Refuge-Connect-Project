<div
    ...
    <div style="padding:12px 14px 14px;">
        ...
        <div style="display:flex;justify-content:space-around;gap:10px;margin-top:12px;">
            <a href="{{route('animal.update', ['id' => $id])}}" style="font-size:12px;color:#2ea7ff;font-weight:700;text-decoration:none;">Modifier</a>
            <a href="{{route('animal.delete', ['id' => $id])}}" style="font-size:12px;color:#2ea7ff;font-weight:700;text-decoration:none;">Supprimer</a>
        </div>
    </div>
</div>